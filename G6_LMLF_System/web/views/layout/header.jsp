...
<header class="top-header">
    ...
    <div class="header-search">
        ...
        <input type="search" aria-label="Search course, syllabus, or curriculum"
    ...
    <div class="header-actions">
        <!-- Nút Thông Báo khẩn -->
        <button class="header-btn" type="button" aria-label="Notifications" title="Notifications" style="position: relative;">
        ...
        <!-- Nút Cài đặt -->
        <button class="header-btn" type="button" aria-label="Settings" title="Settings">
            <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
