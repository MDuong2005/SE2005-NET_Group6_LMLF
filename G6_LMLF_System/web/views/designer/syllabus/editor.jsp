...
<head>
    ...
    <style>
        ...
        @media(max-width:900px){.form-grid{grid-template-columns:1fr}.import-row{grid-template-columns:1fr}.page-heading{flex-direction:column}.sticky-actions{position:static;align-items:stretch;flex-direction:column;gap:12px}.action-right{display:grid;grid-template-columns:1fr 1fr}}
    </style>
</head>
        ...
        <section class="dashboard-content">
            <div class="editor-shell">
                ...
                <form id="editorForm" method="post">
                    ...
                    <section class="editor-section" id="mapping"><div class="section-head"><h2>7. Mapping CLOs to PLOs</h2></div><div class="section-body"><p class="muted small">PLOs are created by the Academic Office. Tick a cell when a CLO contributes to that PLO.</p><div id="mappingContainer"></div></div></section>
