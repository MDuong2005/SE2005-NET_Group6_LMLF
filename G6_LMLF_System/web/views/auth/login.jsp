...
<body>
    ...
    <header>
        ...
        <a href="#" class="header-link">Staff Login</a>
    </header>
    ...
    <main>
        <div class="login-card">
            ...
            <!-- Google OAuth Log-in -->
            <button type="button" class="btn-google" onclick="window.location.href='${pageContext.request.contextPath}/googleOAuth.jsp'">
            ...
            <div class="footer-action">
                New to LMLF? <a href="#">Request access</a>
            </div>
