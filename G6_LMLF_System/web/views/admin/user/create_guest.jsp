...
<head>
    <meta charset="UTF-8">
    <title>Create Guest User - LMLF Admin</title>
        ...
        <div class="form-body">
            <form action="${pageContext.request.contextPath}/admin/guests" method="POST">
                ...
                <div class="form-actions">
                    ...
                    <button type="submit" class="btn btn-submit" style="background-color: #28a745; border-color: #28a745;">Create Guest Account</button>
                </div>
            </form>
        </div>
    </div>
