...
<head>
    ...
    <!-- Main Stylesheet -->
    <link rel="stylesheet" href="${pageContext.request.contextPath}/assets/css/syllabus-role.css">
</head>
<body>
    ...
    <main class="container">
        ...
        <aside class="sidebar">
            ...
            <div class="menu-card">
                <h3 class="menu-title">Curriculum Management</h3>
                <ul class="menu-list">
            ...
            <!-- Workspace Card -->
            <div class="workspace-card" style="background-image: url('${pageContext.request.contextPath}/assets/images/workspace_bg.png');">
                <div class="workspace-text">
                    LMLF Administrative Workspace
                    <div class="workspace-version">v2.4</div>
                </div>
            </div>
        </aside>
